...
/* package run-length-encoding-0.0.0 */
#define VERSION_run_length_encoding "0.0.0"
...
#define CURRENT_COMPONENT_ID "run-length-encoding-0.0.0-GmSDOPvvaU5Fo4lQY6IsZD"

#define CURRENT_PACKAGE_KEY "run-length-encoding-0.0.0-GmSDOPvvaU5Fo4lQY6IsZD"
